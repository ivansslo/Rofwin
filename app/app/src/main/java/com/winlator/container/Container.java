...
public class Container {
    ...
    public static final String LOW_END_MALI_ENV_VARS = "MESA_SHADER_CACHE_DISABLE=false MESA_SHADER_CACHE_MAX_SIZE=128MB mesa_glthread=true WINEESYNC=1 MESA_EXTENSION_MAX_YEAR=2003 WINEDEBUG=-all";
    public static final String DEFAULT_SCREEN_SIZE = "1280x720";
    public static final String LOW_END_MALI_SCREEN_SIZE = "800x600";
    ...
    public static String getDefaultEnvVars(Context context) {
        return GPUHelper.isLowEndMali(context) ? LOW_END_MALI_ENV_VARS : DEFAULT_ENV_VARS;
    }

    public static String getDefaultScreenSize(Context context) {
        return GPUHelper.isLowEndMali(context) ? LOW_END_MALI_SCREEN_SIZE : DEFAULT_SCREEN_SIZE;
    }

    public static String getDefaultDXWrapper(Context context) {
        return GPUHelper.isLowEndMali(context) ? DXWrappers.WINED3D : DEFAULT_DXWRAPPER;
    }

    public static String getDefaultBox64Preset(Context context) {
        return GPUHelper.isLowEndMali(context) ? Box64Preset.PERFORMANCE : Box64Preset.DEFAULT;
    }
