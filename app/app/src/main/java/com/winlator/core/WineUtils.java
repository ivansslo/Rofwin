...
public abstract class WineUtils {
    ...
    public static void applySystemTweaks(Context context, WineInfo wineInfo) {
        ...
        try (WineRegistryEditor registryEditor = new WineRegistryEditor(userRegFile)) {
            ...
            File wineAddonsDir = ObbRuntimeManager.syncWineAddonsIfNeeded(context);
            String addonsURL = wineAddonsDir != null ? "file://"+wineAddonsDir.getAbsolutePath()+"/" : com.winlator.BuildConfig.CONTENT_BASE_URL+"wine_addons/";
            registryEditor.setStringValue("Software\\Wine\\AddonsURL", null, addonsURL);
